...
export function useAdminBrandsPage() {
  ...
  const newBrandTitle =
    ...
    return { t, language, l, tl, brands, setBrands, savedBrands, setSavedBrands, loading, setLoading, saving, setSaving, message, setMessage, error, setError, newBrand, setNewBrand, search, setSearch, q, filteredBrands, saveBrands, updateBrand, updateBrandDescription, updateBrandManufacturer, updateBrandDistributor, handleCreateBrand, handleSaveBrand, handleResetBrand, handleDeleteBrand, newBrandTitle }
}
