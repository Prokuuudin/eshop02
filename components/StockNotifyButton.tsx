    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          className={`stock-notify__trigger w-full gap-2 border-primary/50 text-primary hover:bg-primary/5 dark:border-primary/50 dark:text-primary dark:hover:bg-primary/20 ${compact ? '' : 'mt-3'}`}
        >
