...
function HowItWorks({ t }: { t: (k: string) => string }) {
    ...
    return (
        <div className="rounded-xl border border-indigo-100 bg-primary/5 dark:border-primary/40 dark:bg-indigo-950/30 p-4">
            <button
                className="flex w-full items-center justify-between gap-2 text-left"
                onClick={() => setOpen((v) => !v)}
            >
                <div className="flex items-center gap-2 text-sm font-medium text-primary dark:text-indigo-200">
        ...
        <main className="w-full max-w-3xl mx-auto px-4 py-10">
            ...
            <div className="mb-6">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/5 text-primary dark:bg-primary/20/40 dark:text-primary">
