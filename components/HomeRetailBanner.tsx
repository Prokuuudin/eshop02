...
export default function HomeRetailBanner(): React.ReactElement | null {
    ...
    return (
        <section className="retail-banner px-4 pt-12 md:pt-16">
            <div className="retail-banner__container mx-auto w-full max-w-[1200px] overflow-hidden rounded-2xl border border-amber-200 bg-gradient-to-r from-amber-50 via-white to-rose-50 p-5 shadow-sm dark:border-amber-900/60 dark:from-amber-950/40 dark:via-gray-900 dark:to-rose-950/30 sm:p-6">
