...
export default function AdminPage() {
  ...
  const ALL_CARDS: CardDef[] = [
    ...
    { id: 'rfq',        href: '/admin/rfq',                   adminOnly: false, bg: 'bg-primary/5 dark:bg-indigo-950/20', border: 'border-l-indigo-500',  title: 'B2B RFQ',                            description: tl('admin.dashboard.cards.rfq.description', 'Управление заявками на спецпредложения', 'Manage special offer requests', 'Specialo piedavajumu pieprasijumu parvaldiba'), linkText: tl('admin.dashboard.cards.rfq.open', 'Открыть RFQ панель', 'Open RFQ panel', 'Atvert RFQ paneli') },
    ...
    { id: 'notifications-broadcast', href: '/admin/notifications/send', adminOnly: true, bg: 'bg-primary/5 dark:bg-indigo-950/20', border: 'border-l-indigo-400', title: l('Рассылка уведомлений', 'Notification Broadcast', 'Pazinojumu izplatisana'), description: l('Отправка уведомлений выбранным пользователям в кабинет, email или оба канала', 'Send notifications to selected users via in-cabinet, email, or both channels', 'Nosutiet pazinojumus izveletajiem lietotajiem kabineta, e-pasta vai abos kanalos'), linkText: l('Открыть рассылку', 'Open broadcast', 'Atvert izplatisanu') },
  ]
