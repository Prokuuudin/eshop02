...
import { ChevronDown, Cog, FileText, FolderTree, HandHelping, Megaphone, Settings, ShoppingCart, Users } from 'lucide-react'
...
const NAV_LABELS = {
  ...
  lv: {
    ...
    sales: 'Pardosana',
    'sales.dashboard': 'Pardosanas panelis',
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    <DropdownMenuItem
                      ...
                      asChild
                      className={active ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-200' : ''}
                    >
