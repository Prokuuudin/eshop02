...
export default function NewCategorySection({ state }: { state: CategoriesState }): React.ReactElement {
 ...
 return <><section className="rounded-lg border border-emerald-200 bg-emerald-50/60 p-4 dark:border-emerald-800 dark:bg-emerald-950/20">
          <h2 className="text-lg font-semibold text-foreground">
            {tl('admin.categories.createTitle', 'Ð¡Ð¾Ð·Ð´Ð°Ñ‚ÑŒ Ð½Ð¾Ð²ÑƒÑŽ ÐºÐ°Ñ‚ÐµÐ³Ð¾Ñ€Ð¸ÑŽ', 'Create new category', 'Izveidot jaunu kategoriju')}
          </h2>
          <div className="mt-3 grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px]">
            <div className="grid gap-2 md:grid-cols-3">
              <AccessibleLabel className="text-xs">
                ...
                <Input
                  ...
                  placeholder={tl('admin.categories.placeholder.id', 'ÐÐ°Ð¿Ñ€Ð¸Ð¼ÐµÑ€: hair-care', 'Example: hair-care', 'Piemers: hair-care')}
              ...
              <AccessibleLabel className="text-xs">
                ...
                <Input
                  ...
                  placeholder={tl('admin.categories.placeholder.nameRu', 'Ð£Ñ…Ð¾Ð´ Ð·Ð° Ð²Ð¾Ð»Ð¾ÑÐ°Ð¼Ð¸', 'Hair care', 'Matu kopsana')}
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-2 dark:border-gray-700 dark:bg-gray-800/40">
              <p className="mb-2 text-[11px] font-medium uppercase tracking-wide text-muted-foreground">
                {tl('admin.categories.previewCard', 'ÐŸÑ€ÐµÐ²ÑŒÑŽ ÐºÐ°Ñ€Ñ‚Ð¾Ñ‡ÐºÐ¸', 'Card preview', 'Kartites priekskats')}
              </p>
          ...
          <div className="mt-3 rounded-md border border-dashed border-gray-300 p-3 dark:border-gray-700">
            <p className="text-xs font-medium text-gray-700 dark:text-gray-200">
              {tl('admin.categories.firstSubOptional', 'ÐŸÐµÑ€Ð²Ñ‹Ð¹ Ð¿Ð¾Ð´Ð¿ÑƒÐ½ÐºÑ‚ (Ð¾Ð¿Ñ†Ð¸Ð¾Ð½Ð°Ð»ÑŒÐ½Ð¾)', 'First subcategory (optional)', 'Pirma apakskategorija (neobligata)')}
            </p>
            <div className="mt-2 grid gap-2 md:grid-cols-5">
              <AccessibleLabel className="text-xs">
                ...
                <Input
                  ...
                  placeholder={tl('admin.categories.placeholder.firstSubSlug', 'ÐÐ°Ð¿Ñ€Ð¸Ð¼ÐµÑ€: shampoo', 'Example: shampoo', 'Piemers: shampoo')}
              ...
              <AccessibleLabel className="text-xs">
                ...
                <Input
                  ...
                  placeholder={tl('admin.categories.placeholder.firstSubSearch', 'ÐÐ°Ð¿Ñ€Ð¸Ð¼ÐµÑ€: ÑˆÐ°Ð¼Ð¿ÑƒÐ½ÑŒ', 'Example: shampoo', 'Piemers: sampuns')}
              ...
              <AccessibleLabel className="text-xs">
                ...
                <Input
                  ...
                  placeholder={tl('admin.categories.placeholder.firstSubRu', 'Ð¨Ð°Ð¼Ð¿ÑƒÐ½Ð¸', 'Shampoos', 'Sampuni')}
          ...
          <div className="mt-3 flex justify-end">
            <Button onClick={() => void handleCreateCategory()} disabled={saving}>
              {saving
                ? tl('admin.categories.saving', 'Ð¡Ð¾Ñ…Ñ€Ð°Ð½ÐµÐ½Ð¸Ðµ...', 'Saving...', 'Saglabasana...')
                : tl('admin.categories.createButton', 'Ð¡Ð¾Ð·Ð´Ð°Ñ‚ÑŒ ÐºÐ°Ñ‚ÐµÐ³Ð¾Ñ€Ð¸ÑŽ', 'Create category', 'Izveidot kategoriju')}
            </Button>
          </div>
        </section></>
}
