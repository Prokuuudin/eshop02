...
export function useAdminBlogPage() {
  ...
  const handleCancelBlogEdit = (): void => {
    ...
    return { router, language, t, l, tl, locale, blogPosts, setBlogPosts, blogLoading, setBlogLoading, blogSaving, setBlogSaving, blogMessage, setBlogMessage, blogError, setBlogError, blogForm, setBlogForm, editingBlogId, setEditingBlogId, loadBlogPosts, handleBlogCreate, handleBlogDelete, handleStartEditBlog, handleCancelBlogEdit }
}
