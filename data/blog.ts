...
Помните, что каждая кожа уникальна!
    ...
    category: 'blog.category.faceCare',
    readTime: 5,
...
Носите шапку для защиты.
    ...
    category: 'blog.category.hairCare',
    readTime: 4,
...
Регулярность — ключ к успеху!
    ...
    category: 'blog.category.bodyCare',
    readTime: 3,
...
Используйте SPF днем!
    ...
    category: 'blog.category.ingredients',
    readTime: 6,
