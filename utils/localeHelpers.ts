export function l(language: string, ru: string, en: string, lv: string): string {
...
export function tl(
    ...
    language: string
): (key: string, ru: string, en: string, lv: string, params?: Record<string, string | number>) => string {
