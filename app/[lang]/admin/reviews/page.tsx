...
export default function AdminReviewsPage(): React.ReactElement {
  ...
  const { t, language, l, tl, STATUS_LABELS, STATUS_COLORS, reviews, setReviews, loading, setLoading, savingId, setSavingId, bulkSaving, setBulkSaving, selectedReviewIds, setSelectedReviewIds, search, setSearch, status, setStatus, message, setMessage, error, setError, replyDrafts, setReplyDrafts, replyExpanded, setReplyExpanded, replySavingId, setReplySavingId, loadReviews, filteredClientSide, selectedCount, allVisibleSelected, toggleReviewSelection, toggleSelectAllVisible, applyBulkStatus, removeSelectedReviews, updateStatus, removeReview, toggleReply, saveReply, removeReply } = pageState
return (
    <AdminGate>
