...
> = {
    info:    { icon: Info,          border: 'border-l-indigo-400', dot: 'bg-primary', iconColor: 'text-primary' },
    ...
    return (
        <div
            className={`notifications__item relative flex gap-3 rounded-lg border-l-4 p-4 transition-colors ${cfg.border} ${
                isSelected
                    ? 'bg-primary/5 dark:bg-indigo-950/20'
                    : notification.isRead
                    ? 'bg-card'
                    : 'bg-muted/60'
            }`}
                    ...
                    {unread > 0 && (
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <span className="notifications__badge-unread inline-flex items-center rounded-full bg-primary/10 px-2 py-0.5 text-xs font-bold text-primary dark:bg-primary/20/40 dark:text-primary cursor-default shrink-0">
                                    {unread}
                                </span>
                            </TooltipTrigger>
                            <TooltipContent>
                            ...
                            return (
                                <label
                                    ...
                                    className={`notifications__channel-option flex cursor-pointer items-center gap-2 rounded-lg border px-3 py-2 text-sm transition-colors ${
                                        isActive
                                            ? 'border-primary/70 bg-primary/5 text-primary dark:border-primary dark:bg-indigo-950/30 dark:text-primary'
