...
const NAV_LABELS = {
    ...
    lv: {
        menu: 'Izvēlne',
        catalog: 'Katalogs',
        'catalog.products': 'Produktu kartītes',
        'catalog.categories': 'Kategorijas',
        'catalog.brands': 'Zīmoli',
        ...
        'sales.rfq': 'RFQ pieprasījumi',
        'sales.returns': 'Atgriešana un atcelšana',
        'sales.analytics': 'Pārdošanas analītika',
        customers: 'Klienti',
        'customers.accounts': 'Uzņēmumu konti',
        'customers.barcodes': 'Klientu kartes',
        'customers.registered': 'Reģistrētie klienti',
        'customers.database': 'Klientu datubāze',
        ...
        'content.media': 'Mediju bibliotēka',
        ...
        system: 'Sistēma',
        'system.users': 'Lietotāji un lomas',
        'system.audit': 'Audita žurnāls',
        'system.logs': 'Žurnāli un notikumi',
        'system.backup': 'Rezerves kopijas un atjaunošana',
        help: 'Palīdzība',
