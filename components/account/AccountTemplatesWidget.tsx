...
export const AccountTemplatesWidget: React.FC = () => {
    ...
    return (
        <Link
            ...
            className="group flex flex-col rounded-2xl border border-indigo-100 bg-primary/5 p-5 shadow-sm hover:shadow-md hover:border-primary/30 dark:border-primary/40 dark:bg-primary/10 dark:hover:border-indigo-700 transition-all"
        >
