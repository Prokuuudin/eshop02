...
```ts
  ...
  'deliveryPayment.rules.item6': 'Доставка осуществляется по рабочим дням с 09.00 до 17.00.',
...
```ts
  ...
  'deliveryPayment.rules.item6': 'Delivery takes place on business days from 09.00 to 17.00.',
...
```ts
  ...
  'deliveryPayment.rules.item6': 'Piegāde notiek darba dienās no plkst. 09.00 līdz 17.00.',
