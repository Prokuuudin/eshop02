...
// Phase 2a — ONLY pixel-identical background mappings (token value == current pair).
//   --card:  white / gray-900   == bg-white dark:bg-gray-900
//   --muted: gray-100 / gray-800 == bg-gray-100 dark:bg-gray-800
// Ambiguous combos (bg-white dark:bg-gray-800, bg-gray-950, bg-gray-200 dark:bg-gray-700,
// bg-gray-50 dark:*) are NOT touched — they have no exact-match token and need manual review.
const REPLACEMENTS = [
