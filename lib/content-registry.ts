...
export const CONTENT_REGISTRY: ContentSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { type: 'text', key: 'deliveryPayment.methods.venipak.label', label: 'Venipak — заголовок' },
      { type: 'text', key: 'deliveryPayment.methods.venipak.price', label: 'Venipak — цена' },
      { type: 'text', key: 'deliveryPayment.methods.unisend.label', label: 'Unisend — заголовок' },
      { type: 'text', key: 'deliveryPayment.methods.unisend.price', label: 'Unisend — цена' },
      { type: 'text', key: 'deliveryPayment.methods.lockers.limitsTitle', label: 'Пакоматы — заголовок ограничений' },
  ...
  },
  {
    ...
    entries: [
      ...
      { type: 'text', key: 'deliveryPayment.payment.paysera.label', label: 'Paysera — заголовок' },
      { type: 'text', key: 'deliveryPayment.payment.paysera.note', label: 'Paysera — пояснение', multiline: true },
      { type: 'text', key: 'deliveryPayment.payment.paypal.label', label: 'PayPal — заголовок' },
      { type: 'text', key: 'deliveryPayment.payment.paypal.note', label: 'PayPal — пояснение', multiline: true },
