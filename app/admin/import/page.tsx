            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {fileName && (
                <>
                  ...
                  <span className="text-sm text-muted-foreground">— {rows.length} строк</span>
                    ...
                    <table className="min-w-full text-xs">
                      <thead className="bg-gray-50 dark:bg-gray-800 sticky top-0 z-10">
                        <tr>
                          ...
                          <th className="px-3 py-2 text-left text-muted-foreground font-medium whitespace-nowrap">ID</th>
                          <th className="px-3 py-2 text-left text-muted-foreground font-medium whitespace-nowrap">Название</th>
                          <th className="px-3 py-2 text-left text-muted-foreground font-medium whitespace-nowrap">Бренд</th>
                          <th className="px-3 py-2 text-left text-muted-foreground font-medium whitespace-nowrap">Цена</th>
                          <th className="px-3 py-2 text-left text-muted-foreground font-medium whitespace-nowrap">Остаток</th>
                          <th className="px-3 py-2 text-left text-muted-foreground font-medium whitespace-nowrap">SKU</th>
                        </tr>
                      </thead>
                        ...
                        {previewResult.rows.map((row) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td className="px-3 py-2 text-muted-foreground whitespace-nowrap">{row.brand || '—'}</td>
                              <td className="px-3 py-2 text-muted-foreground whitespace-nowrap tabular-nums">
                                {row.price ? `€${row.price}` : '—'}
                              </td>
                              <td className="px-3 py-2 text-muted-foreground whitespace-nowrap tabular-nums">{row.stock || '—'}</td>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                ...
                <div className={`rounded-lg border p-3 text-center ${
                  ...
                  <p className={`text-xs mt-0.5 ${result.errors.length > 0 ? 'text-red-600 dark:text-red-400' : 'text-muted-foreground'}`}>
                    Ошибок
                  </p>
                </div>
              </div>
