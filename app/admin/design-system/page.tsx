      ...
      <main className="w-full py-4 space-y-14 text-foreground">
        ...
        <Section title="5 · Badges">
          <div className="flex flex-wrap gap-3 items-center">
            ...
            <span className="inline-flex items-center rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-semibold text-primary dark:bg-primary/40 dark:text-primary">Новинка</span>
