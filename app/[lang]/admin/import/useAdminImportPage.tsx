...
export function useAdminImportPage() {
  ...
  // ── Render ────────────────────────────────────────────────────────────────
    ...
    return { rows, setRows, fileName, setFileName, mode, setMode, importing, setImporting, previewing, setPreviewing, result, setResult, previewResult, setPreviewResult, parseError, setParseError, missingCols, setMissingCols, fileRef, onFileChange, onReset, onModeChange, onPreview, onImport, detectedCols, canImport }
}
