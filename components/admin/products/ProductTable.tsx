...
const ProductTable: React.FC<ProductTableProps> = ({
    ...
    const cellCls = 'px-2 py-1 w-24 rounded border border-primary/50 dark:border-primary bg-card text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-indigo-400'
                                ...
                                <td className="p-3 align-middle">
                                    {isEditingPrice ? (
                                        ...
                                        <button
                                            ...
                                            className={`text-sm font-medium text-foreground tabular-nums ${onQuickSave ? 'rounded px-1.5 py-0.5 hover:bg-primary/5 dark:hover:bg-indigo-900/20 hover:text-primary/90 cursor-pointer' : 'cursor-default'}`}
                                        >
                                ...
                                <td className="p-3 align-middle">
                                    {isEditingStock ? (
                                        ...
                                        <button
                                            ...
                                            title={onQuickSave ? 'Кликните для редактирования' : undefined}
                                            className={`text-sm tabular-nums ${onQuickSave ? 'rounded px-1.5 py-0.5 hover:bg-primary/5 dark:hover:bg-indigo-900/20 cursor-pointer' : 'cursor-default'} ${product.stock === 0 ? 'text-red-600 dark:text-red-400 font-semibold' : product.stock <= 5 ? 'text-amber-600 dark:text-amber-400 font-medium' : 'text-foreground'}`}
                                        >
                                            {product.stock}
                                        </button>
                                    )}
