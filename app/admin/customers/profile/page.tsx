        ...
        <div className="flex flex-wrap items-start gap-5">
          ...
          <div className="flex gap-2">
            ...
            <Link href={`/admin/orders?q=${encodeURIComponent(email)}`}>
              <button type="button" className="rounded-lg border border-primary/30 dark:border-primary/40 bg-primary/5 dark:bg-primary/10 px-3 py-1.5 text-sm text-primary dark:text-primary hover:bg-primary/10 dark:hover:bg-indigo-900/40 transition-colors">
                Все заказы ↗
              </button>
            </Link>
          </div>
