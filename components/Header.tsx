                  ...
                  <div className="hidden shrink-0 items-center gap-1 md:ml-auto md:flex">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <a href="https://www.instagram.com/miksplusveikals" target="_blank" rel="noopener noreferrer" aria-label={t('footer.instagram')} className="rounded-md p-2 text-brand transition-colors hover:bg-black/5 hover:text-pink-600 dark:text-white dark:hover:bg-white/10 dark:hover:text-pink-400">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <a href="https://www.facebook.com/share/1E9VE5FpA7/" target="_blank" rel="noopener noreferrer" aria-label={t('footer.facebook')} className="rounded-md p-2 text-brand transition-colors hover:bg-black/5 hover:text-blue-600 dark:text-white dark:hover:bg-white/10 dark:hover:text-blue-400">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <a href="https://www.tiktok.com/@miks_plus" target="_blank" rel="noopener noreferrer" aria-label={t('footer.tiktok')} className="rounded-md p-2 text-brand transition-colors hover:bg-black/5 hover:text-black dark:text-white dark:hover:bg-white/10 dark:hover:text-white">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <a href="https://youtube.com/@miksplus" target="_blank" rel="noopener noreferrer" aria-label={t('footer.youtube')} className="rounded-md p-2 text-brand transition-colors hover:bg-black/5 hover:text-red-600 dark:text-white dark:hover:bg-white/10 dark:hover:text-red-400">
