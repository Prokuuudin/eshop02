...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Используйте Продвижение → Подборки: задайте заголовки, slug, описание, изображение, список товаров, порядок и активность. Для баннера или отдельного промо-блока откройте Контент → Баннеры и блоки. После сохранения проверьте главную страницу на всех нужных языках; место показа зависит от типа и настроек блока.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    answer:
      'Для изменения по бренду, категории или выбранным товарам откройте Каталог → Массовые цены и обязательно проверьте предпросмотр. Для большого набора цен и остатков откройте Импорт / Экспорт, скачайте актуальный каталог, измените CSV и нажмите «Проверить файл». Запускайте импорт только после проверки строк create/update/skip/error и резервной копии.',
  },
  {
    id: 11,
