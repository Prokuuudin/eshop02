const enCheckout: Record<string, string> = {
  ...
  'checkout.errors.regNumber': 'Registration number is required',
  'checkout.vatNumber': 'VAT number',
  'checkout.legalAddress': 'Legal address',
  'checkout.errors.legalAddress': 'Legal address is required',
  'checkout.bankName': 'Bank',
  'checkout.errors.bankName': 'Bank is required',
  'checkout.iban': 'IBAN',
  'checkout.errors.iban': 'IBAN is required',
  'checkout.contactsHeading': 'Your contacts',
  'checkout.delivery.title': 'Your details',
  'checkout.prefill.hint': 'The form automatically uses your profile or last order details. Edit them manually if needed.',
  ...
  'checkout.payment.paysera': 'Online payment (Paysera)',
  'checkout.payment.bankHint': 'An invoice will be emailed — pay by transfer quoting the order number.',
  'checkout.payment.cashHint': 'In cash or by card when picking up at our Riga office.',
  'checkout.payment.payseraHint': 'Right after ordering — via your online bank on the secure Paysera page.',
  ...
  'checkout.payment.cashDeliveryAlert': 'With cash on delivery, only pickup from our Rencēnu 10A office is available. Change the payment method or switch back to that address.',
  ...
  'checkout.items.add': 'Add product',
  'checkout.items.decrease': 'Decrease quantity',
  'checkout.items.increase': 'Increase quantity',
  'checkout.items.removeFromOrder': 'Remove from order',
  'checkout.items.removeConfirm': 'Remove this product from the order?',
  'checkout.bonus.label': 'Bonus points',
  'checkout.bonus.available': 'Available points',
  'checkout.bonus.max': 'You can use up to',
  'checkout.bonus.willEarn': 'After order',
  'cart.bonus.unit': 'pts',
  ...
  'order.delivery.post': 'Omniva parcel lockers',
  'order.delivery.venipak': 'Venipak parcel lockers',
  'order.payment.card': 'Bank card',
  'order.payment.bank': 'Bank transfer',
  'order.payment.cash': 'Cash on delivery',
  'order.payment.paysera': 'Online payment (Paysera)',
  ...
  'order.payingNow': 'Redirecting to payment…',
